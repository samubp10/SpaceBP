...
return [
    ...
    "Total:" => "Total:",
    "Trashed" => "Desechado",
    "TRAVEL TO OUTER SPACE WITH SPACEBP" => "VIAJA AL ESPACIO EXTERIOR CON SPACEBP",
    "SpaceBP is a web page where you can learn, share knowledge, know about the latest news, and many other things about the space."   => "SpaceBP es una página web en la que puedes aprender, conpartir conocimiento, conocer las últimas noticias, y muchas otras cosas sobre el espacio",
